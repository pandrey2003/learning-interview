...
class DoublyLinkedList:
    ...
    def print_all_nodes_in_reverse(self):
        ...
        while current.next:
            current = current.next
        while current:
            list_of_reversed_nodes.append(str(current.data))
            current = current.previous
        print(" <- ".join(list_of_reversed_nodes))
